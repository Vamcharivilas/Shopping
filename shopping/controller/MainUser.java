...
import shopping.dao.PaymentCrud;
...
public class MainUser {
	...
	static CustomerCrud cc = new CustomerCrud();
	static ShopCrud sc = new ShopCrud();
	static ProductCrud pc = new ProductCrud();
	static PaymentCrud pC = new PaymentCrud();
	...
	private static void loginCustomer() {
		...
		try {
			...
			System.out.println("Please ensure your data is correct...");
			loginCustomer();
		}
		customerShop(c);
	...
	private static void payment(Customer c) {
		...
		if (l != null) {
			...
			boolean val = true;
			System.out.println(
					"If you want to remove print 'yes' or you want to buy all the item print 'no'");
			String ans = scr.next();
			if (ans.equalsIgnoreCase("yes")) {

				do {
					System.out.println(
							" If you want to remove print 'yes' or you do not went then print 'no'");
...
//			
			...
			if (c.getL().getP() != null) {
				...
				System.out.println("Enter the mode you want to pay");
	...
	private static void cart(Customer c) {
		...
		do {
			System.out.println(
					"Do you want to buy the products print 'yes' if you want to buy or 'no' if do not want to buy:");
			String s = scr.next();
			if (s.equalsIgnoreCase("yes")) {
				...
				boolean temp = true;
				do {
					System.out.println("Enter the number of item you want buy:");
					num = scr.nextInt();
					if (num > p.getNumberOfProduct()) {
						System.out.println("Your order is greater than the items available in store ");
	...
	private static boolean profile(Customer c) {
		...
		do {
			...
			if (s.equals("1")) {
				...
				cc.remove(c);
				System.out.println("Your account was deleted please create another account");
				values = false;
				temp = 1;
			} else if (s.equals("3")) {
				c = cc.find(c.getId());
				...
				System.out.println("Your data is incorrect please ensure your data is correct...");
			}
		} while (values);
		if (temp == 1) {
			return true;
	...
	private static void registerCustomer() {
		...
		try {
			...
			System.out.println("Email already exist use another email...");
			registerVendor();
		}
